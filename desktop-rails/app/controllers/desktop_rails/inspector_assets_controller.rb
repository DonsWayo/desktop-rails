module DesktopRails
  ...
  # shell's `desktop-rails.js` can `import()` it same-origin.
  #
  ...
  class InspectorAssetsController < ActionController::Base
    ASSET_ROOT = DesktopRails::Engine.root.join("lib/desktop_rails/inspector_assets").freeze
    ...
    # GET /desktop-rails/inspector/<module>.js
    def show
      rel = requested_asset
